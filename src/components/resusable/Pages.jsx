    ...
    <div className="container-xxl p-2">
      ...
      <div className="row gx-5 mt-4" style={{ height: "auto" }}>
            ...
            <div className="border-bottom d-grid gap-4 py-3">
              <div className="row border-bottom">
                <div className="col-12 col-md-4 col-lg-4">
                  ...
                  {API?.slice(11, 12).map((item, index) => (
                    <div key={index}>
                      <a href={item.url}>
                        <div className="card">
                          <div className="card-body mt-3">
                ...
                <div className="col-md-8 col-lg-8">
                  {API?.slice(12, 13).map((item, index) => (
                    <div key={index}>
                      <a href={item.url}>
                        <div className="card">
                          <div
              ...
              <div className="row gy-4">
                {API?.slice(10, 16).map((item, index) => {
                  return (
        ...
        <div className="col-xs-12 col-md-12 col-lg-3 border-start order-2 order-md-2 order-lg-2">
          ...
          {API?.slice(12, 20).map((item, index) => (
            <div key={index}>
              <a href={item.url}>
                <div className="card ">
                  <div className="card-body p-0 border-bottom mt-3">
          ...
          {API?.slice(20, 21).map((item, index) => (
            <div key={index}>
              <a href={item.url}>
                <div className="card ">
