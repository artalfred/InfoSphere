      ...
      <div className="container-xxl p-2">
        ...
        <div className="row gx-5 mt-4" style={{ height: "auto" }}>
              ...
              <div className="border-bottom d-flex gap-4 pb-3">
                <div className="row">
                  <div className="col-12 col-md-4 col-lg-4 order-2 order-sm-2 order-md-2 order-lg-1">
                    ...
                    {Sports.slice(2, 3).map((item, index) => (
                      <div key={index}>
                        <a href={item.url}>
                          <div className="card">
                  ...
                  <div className="col-12 col-md-8 col-lg-8 order-1 order-sm-1 order-md-1 order-lg-2">
                    {Sports.slice(3, 4).map((item, index) => (
                      <div key={index}>
                        <a href={item.url}>
                          <div className="card">
                            <img
              ...
              <div className="border-bottom d-grid gap-4 py-3">
                <div className="row border-bottom">
                  <div className="col-12 col-md-4 col-lg-4">
                    {Sports.slice(9, 11).map((item, index) => (
                      <div key={index}>
                        <a href={item.url}>
                          <div className="card ">
                    ...
                    {Sports.slice(11, 12).map((item, index) => (
                      <div key={index}>
                        <a href={item.url}>
                          <div className="card">
                            <div className="card-body mt-3">
                  ...
                  <div className="col-md-8 col-lg-8">
                    {Sports.slice(12, 13).map((item, index) => (
                      <div key={index}>
                        <a href={item.url}>
                          <div className="card">
                            <div
                ...
                <div className="row gy-4">
                  {Sports.slice(10, 16).map((item, index) => {
                    return (
          ...
          <div className="col-xs-12 col-md-12 col-lg-3 border-start order-2 order-md-2 order-lg-2">
            {Sports.slice(5, 6).map((item, index) => (
              <div key={index}>
                <a href={item.url}>
                  <div className="card ">
                    <img
            ...
            {Sports.slice(12, 20).map((item, index) => (
              <div key={index}>
                <a href={item.url}>
                  <div className="card ">
                    <div className="card-body p-0 border-bottom mt-3">
            ...
            {Sports.slice(20, 21).map((item, index) => (
              <div key={index}>
                <a href={item.url}>
                  <div className="card ">
        ...
        <div className="row gy-4 border-bottom mt-3 pb-4">
          <h3 className="fw-bold body-text">Sports</h3>
          {Sports.slice(4, 12).map((item, index) => {
            return (
